...
struct ChartView: View {
    ...
    var body: some View {
        ...
        .chartForegroundStyleScale([
            Sentiment.positive : Sentiment.positive.sentimentColour,
            Sentiment.negative : Sentiment.negative.sentimentColour,
            Sentiment.moderate : Sentiment.moderate.sentimentColour
        ])
